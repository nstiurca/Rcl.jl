...
# Skipping MacroDefinition: RCUTILS_LOG_DEBUG_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_DEBUG , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_DEBUG_SKIPFIRST_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_DEBUG , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_DEBUG_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_DEBUG , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , name , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_DEBUG_SKIPFIRST_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_DEBUG , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , name , __VA_ARGS__ )
...
# Skipping MacroDefinition: RCUTILS_LOG_INFO_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_INFO , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_INFO_SKIPFIRST_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_INFO , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_INFO_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_INFO , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , name , __VA_ARGS__ )
...
# Skipping MacroDefinition: RCUTILS_LOG_WARN_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_WARN , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_WARN_SKIPFIRST_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_WARN , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_WARN_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_WARN , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , name , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_WARN_SKIPFIRST_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_WARN , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , name , __VA_ARGS__ )
...
# Skipping MacroDefinition: RCUTILS_LOG_ERROR_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_ERROR , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_ERROR_SKIPFIRST_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_ERROR , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_ERROR_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_ERROR , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , name , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_ERROR_SKIPFIRST_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_ERROR , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , name , __VA_ARGS__ )
...
# Skipping MacroDefinition: RCUTILS_LOG_FATAL_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_FATAL , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_FATAL_SKIPFIRST_THROTTLE ( time_source_type , duration , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_FATAL , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , NULL , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_FATAL_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_FATAL , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) , RCUTILS_LOG_CONDITION_THROTTLE_AFTER , name , __VA_ARGS__ )
# Skipping MacroDefinition: RCUTILS_LOG_FATAL_SKIPFIRST_THROTTLE_NAMED ( time_source_type , duration , name , ... ) RCUTILS_LOG_COND_NAMED ( RCUTILS_LOG_SEVERITY_FATAL , RCUTILS_LOG_CONDITION_THROTTLE_BEFORE ( time_source_type , duration ) RCUTILS_LOG_CONDITION_SKIPFIRST_BEFORE , RCUTILS_LOG_CONDITION_THROTTLE_AFTER RCUTILS_LOG_CONDITION_SKIPFIRST_AFTER , name , __VA_ARGS__ )
...
RCUTILS_S_TO_NS(seconds) = 1_000_000_000seconds
RCUTILS_MS_TO_NS(milliseconds) = 1_000_000milliseconds
RCUTILS_US_TO_NS(microseconds) = 1000microseconds
RCUTILS_NS_TO_S(nanoseconds) = nanoseconds ÷ 1_000_000_000
RCUTILS_NS_TO_MS(nanoseconds) = nanoseconds ÷ 1_000_000
RCUTILS_NS_TO_US(nanoseconds) = nanoseconds ÷ 1_000
...
# Skipping MacroDefinition: rcutils_win32_atomic_compare_exchange_strong ( object , out , expected , desired ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedCompareExchange64 ( ( LONGLONG * ) object , desired , * expected ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedCompareExchange ( ( LONG * ) object , desired , * expected ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedCompareExchange16 ( ( SHORT * ) object , desired , * expected ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedCompareExchange8 ( ( char * ) object , desired , * expected ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_compare_exchange_strong" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
...
# Skipping MacroDefinition: rcutils_win32_atomic_exchange ( object , out , desired ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedExchange64 ( ( LONGLONG * ) object , desired ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedExchange ( ( LONG * ) object , desired ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedExchange16 ( ( SHORT * ) object , desired ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedExchange8 ( ( char * ) object , desired ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_exchange_strong" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
# Skipping MacroDefinition: rcutils_win32_atomic_fetch_add ( object , out , operand ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedExchangeAdd64 ( ( LONGLONG * ) object , operand ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedExchangeAdd ( ( LONG * ) object , operand ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedExchangeAdd16 ( ( SHORT * ) object , operand ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedExchangeAdd8 ( ( char * ) object , operand ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_fetch_add" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
# Skipping MacroDefinition: rcutils_win32_atomic_fetch_and ( object , out , operand ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedAnd64 ( ( LONGLONG * ) object , operand ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedAnd ( ( LONG * ) object , operand ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedAnd16 ( ( SHORT * ) object , operand ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedAnd8 ( ( char * ) object , operand ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_fetch_and" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
# Skipping MacroDefinition: rcutils_win32_atomic_fetch_or ( object , out , operand ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedOr64 ( ( LONGLONG * ) object , operand ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedOr ( ( LONG * ) object , operand ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedOr16 ( ( SHORT * ) object , operand ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedOr8 ( ( char * ) object , operand ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_fetch_or" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
...
# Skipping MacroDefinition: rcutils_win32_atomic_fetch_xor ( object , out , operand ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedXor64 ( ( LONGLONG * ) object , operand ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedXor ( ( LONG * ) object , operand ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedXor16 ( ( SHORT * ) object , operand ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedXor8 ( ( char * ) object , operand ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_fetch_xor" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
# Skipping MacroDefinition: rcutils_win32_atomic_load ( object , out ) __pragma ( warning ( push ) ) __pragma ( warning ( disable : 4244 ) ) do { switch ( sizeof ( out ) ) { case sizeof ( uint64_t ) : out = _InterlockedExchangeAdd64 ( ( LONGLONG * ) object , 0 ) ; break ; case sizeof ( uint32_t ) : out = _InterlockedExchangeAdd ( ( LONG * ) object , 0 ) ; break ; case sizeof ( uint16_t ) : out = _InterlockedExchangeAdd16 ( ( SHORT * ) object , 0 ) ; break ; case sizeof ( uint8_t ) : out = _InterlockedExchangeAdd8 ( ( char * ) object , 0 ) ; break ; default : RCUTILS_LOG_ERROR_NAMED ( ROS_PACKAGE_NAME , "Unsupported integer type in atomic_load" ) ; exit ( - 1 ) ; break ; } } while ( 0 ) ; __pragma ( warning ( pop ) )
